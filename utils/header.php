<header class="bgImage">
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "viewEvents.php">Eventos</a></li>';
                    echo '<li><a href = "viewLocations.php">Localização</a></li>';
                    echo '<li><a href = "contact.php">Entre em contato</a></li>';
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "index.php">Home</a></li>';
                    echo '<li><a href = "events2.php">Eventos</a></li>';
                    echo '<li><a href = "locations2.php">Localização</a></li>';
                    echo '<li><a href = "contact.php">Entre em contato</a></li>';
                                    ...
                                    <div class="col-md-6 col-md-offset-3">
                                        <form action="login.php" method="POST">
                                            ...
                                            <a class="btn btn-default navbar-btn rgsterbtn"
                                                href="register_form.php">Cadastrar</a>
                                            <!--register button-->
                                        </form>
                                    </div>
                                </div>
    ...
    <div class="col-md-12">
        <div class="container">
            <div class="jumbotron">
                <!--jumbotron-->
                <h1>UP promotora & Organizadora de Eventos</h1>
                <!--jumbotron heading-->
                <p>
                    <!--jumbotron content-->
